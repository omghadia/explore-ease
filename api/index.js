...
app.get('/test',(req,res)=>{
    mongoose.connect('mongodb+srv://booking:X7v3EAFBhnUAwtau@cluster0.csxdfmf.mongodb.net/');
    res.json('test ok');
});
...
app.post('/places', (req,res) =>{
    ...
    jwt.verify(token,jwtSecret,{},async (err,userData) =>{
        ...
        const placeDoc = await Place.create({
            ...
            perks,extraInfo,checkIn,checkOut,price,maxGuests,
        });
        res.json(placeDoc);
    });
});
